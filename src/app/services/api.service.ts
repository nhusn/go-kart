...
export class ApiService {
  ...
  cartIncrementAPI(id: any) {
    return this.http.get(`${this.SERVER_URL}/cart/increment/${id}`, this.appendTokenToHeaders())
  }

  // decrementAPI
  cartDecrementAPI(id: any) {
    return this.http.get(`${this.SERVER_URL}/cart/decrement/${id}`, this.appendTokenToHeaders())
  }

  // cart remove
  removeCartItemAPI(id:any){
    return this.http.delete(`${this.SERVER_URL}/cart/remove/${id}`,this.appendTokenToHeaders())
  }

   // cart empty
   emptyCartItemAPI(){
    return this.http.delete(`${this.SERVER_URL}/cart/empty`,this.appendTokenToHeaders())
  }
}
